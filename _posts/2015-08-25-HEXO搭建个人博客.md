...
## 莫比乌斯带(Mobius band)
  ...
  莫比乌斯带它是一个只有一个面的曲面，这么说可能觉得很抽象，我们来看看它是怎么得到的吧。![image](https://github.com/dfdfwff/dfdfwff.github.io/assets/102846037/378a3f4e-b69d-4fe8-8c39-2094028746f7)
  ...
  通过这些图，我们可以很直观的看到一点，就是它真的只有一个面。
 
## 公式表达
  在标准的三维坐标系下，我们可以这样表示出莫比乌斯带
